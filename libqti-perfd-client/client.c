...
void perf_event(int arg1, char *arg2, int arg3, int *arg4) {
    ALOGI("perf_event: arg1: %d, arg2: %c, arg3: %d, arg4: %d", arg1, arg2,
          arg3[0], arg4);
}

int perf_get_feedback(int arg1, char *arg2) {
    ALOGI("perf_get_feedback: arg1: %d, arg2: %c", arg1, arg2);
    return 0;
}

int perf_get_feedback_extn(int arg1, char *arg2, unsigned int arg3, char *arg4) {
    ALOGI("perf_get_feedback_extn: arg1: %d, arg2: %c, arg3: %u, arg4: %c", arg1, arg2,
          arg3, arg4);
    return 0;
}

void perf_hint(int arg1, char *arg2, int arg3, int arg4) {
    ALOGI("perf_hint: arg1: %d, arg2: %c, arg3: %d, arg4: %d", arg1, arg2,
          arg3, arg4);
}
...
void perf_wait_get_prop(char *arg1, char *arg2) {
    ALOGI("perf_wait_get_prop: arg1: %c, arg2: %c", arg1, arg2);
}
